...
This repository contains the implementation of [CSIP](https://www.ewadirect.com/proceedings/ace/article/view/15037) and can be used to reproduce the results in the paper. The implementation is based on an open source implementation of OpenAI's [CLIP](https://github.com/openai/CLIP). 
